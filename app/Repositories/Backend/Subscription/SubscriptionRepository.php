    ...
    public function getForDataTable()
    {
        return $this->query()
            ->select([
                ...
                config('module.subscriptions.table').'.purchase_points_ar',
                config('module.subscriptions.table').'.free_points',
                config('module.subscriptions.table').'.free_points_ar',
                config('module.subscriptions.table').'.discount',
                config('module.subscriptions.table').'.discount_ar',
                config('module.subscriptions.table').'.details',
                config('module.subscriptions.table').'.details_ar',
                config('module.subscriptions.table').'.duration',
                config('module.subscriptions.table').'.duration_ar',
