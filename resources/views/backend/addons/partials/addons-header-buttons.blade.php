<!--Action Button-->
@if( Active::checkUriPattern( 'admin/addons' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.addons.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.addons.all' ) }}
            </a>
        </li>
        @permission( 'create-addon' )
            <li>
                <a href="{{ route( 'admin.addons.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.addons.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
