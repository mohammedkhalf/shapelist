<!--Action Button-->
@if( Active::checkUriPattern( 'admin/carts' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.carts.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.carts.all' ) }}
            </a>
        </li>
        @permission( 'create-cart' )
            <li>
                <a href="{{ route( 'admin.carts.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.carts.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
