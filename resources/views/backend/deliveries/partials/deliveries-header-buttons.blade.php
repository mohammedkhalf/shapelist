<!--Action Button-->
@if( Active::checkUriPattern( 'admin/deliveries' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.deliveries.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.deliveries.all' ) }}
            </a>
        </li>
        @permission( 'create-delivery' )
            <li>
                <a href="{{ route( 'admin.deliveries.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.deliveries.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
