                ...
                <table id="locations-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.backend.locations.table.country') }}</th>
                            <th>{{ trans('labels.backend.locations.table.city') }}</th>                   
        ...
        $(function() {
            ...
            var dataTable = $('#locations-table').dataTable({
                ...
                columns: [
                    ...
                    {data: 'country', name: '{{config('module.locations.table')}}.country'},
                    {data: 'city', name: '{{config('module.locations.table')}}.city'},
