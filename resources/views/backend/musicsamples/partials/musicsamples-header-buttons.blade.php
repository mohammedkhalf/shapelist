<!--Action Button-->
@if( Active::checkUriPattern( 'admin/musicsamples' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.musicsamples.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.musicsamples.all' ) }}
            </a>
        </li>
        @permission( 'create-musicsample' )
            <li>
                <a href="{{ route( 'admin.musicsamples.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.musicsamples.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
