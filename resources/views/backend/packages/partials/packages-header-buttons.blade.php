<!--Action Button-->
@if( Active::checkUriPattern( 'admin/packages' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.packages.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.packages.all' ) }}
            </a>
        </li>
        @permission( 'create-package' )
            <li>
                <a href="{{ route( 'admin.packages.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.packages.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
