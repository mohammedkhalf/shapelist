<!--Action Button-->
@if( Active::checkUriPattern( 'admin/platforms' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.platforms.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.platforms.all' ) }}
            </a>
        </li>
        @permission( 'create-platform' )
            <li>
                <a href="{{ route( 'admin.platforms.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.platforms.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
