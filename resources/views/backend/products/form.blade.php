<div class="box-body">
    <div class="form-group">
        ...
        <div class="col-lg-10">
            ...
            <!-- Look Below Example for reference -->
            {{ Form::text('name', old('name'), ['class' => 'form-control box-size', 'placeholder' => trans('labels.backend.products.product-name'), 'required' => 'required']) }}
        </div><!--col-lg-10-->
    </div><!--form-group-->
    <div class="form-group">
        <!-- Create Your Field Label Here -->
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <!-- Create Your Input Field Here -->
            <!-- Look Below Example for reference -->
            {!! Form::file('image', old('image')  ,array('class'=>'form-control inputfile inputfile-1' , 'required' => 'required' )) !!} <br/>
