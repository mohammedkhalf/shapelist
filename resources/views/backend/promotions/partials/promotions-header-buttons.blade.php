<!--Action Button-->
@if( Active::checkUriPattern( 'admin/promotions' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.promotions.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.promotions.all' ) }}
            </a>
        </li>
        @permission( 'create-promotion' )
            <li>
                <a href="{{ route( 'admin.promotions.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.promotions.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
