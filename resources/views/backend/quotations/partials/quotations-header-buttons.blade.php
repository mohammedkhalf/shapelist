<!--Action Button-->
@if( Active::checkUriPattern( 'admin/quotations' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.quotations.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.quotations.all' ) }}
            </a>
        </li>
        @permission( 'create-quotation' )
            <li>
                <a href="{{ route( 'admin.quotations.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.quotations.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
