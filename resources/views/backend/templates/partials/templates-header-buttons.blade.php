<!--Action Button-->
@if( Active::checkUriPattern( 'admin/templates' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.templates.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.templates.all' ) }}
            </a>
        </li>
        @permission( 'create-template' )
            <li>
                <a href="{{ route( 'admin.templates.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.templates.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
