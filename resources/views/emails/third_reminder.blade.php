   ...
   <div class="fd-card middle">
        <div class="fd-header center">
                ...
                <p style="font-size:15px ; text-align:center; font-weight: 600; opacity: 0.8;"> Hello, {{$subscriber->user->first_name}} {{$subscriber->user->last_name}}!</p>
                    <p style="font-size:13px ; text-align:center; font-weight: lighter; color:#FFFFFF ;opacity: 0.8;"> Points Reminder </p>
                </div>       
        </div>
      
        <div class="fd-email-body"  style="color: #000000a1; font-weight: 700; padding-top: 18px !important;">
            <p class="fd-email-text"  style="color: #000000a1; opacity: 0.8;">   Your subscription has expired 10 days ago,</p>
            <p style="color: #000000a1;opacity: 0.8;"> You will lose your points if you don’t renew your subscription, </p>
            <p style="color: #000000a1;opacity: 0.8;"> visit your dashboard To renew your inactive subscription. </p>
